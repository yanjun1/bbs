  ...
  <div class="admin-content">
    ...
    <div class="am-g">
      <div class="am-u-sm-12">
        <h2 class="am-text-center am-text-xxxl am-margin-top-lg">ERROR. 出错了</h2>
        <p class="am-text-center"><%= request.getAttribute("msg") %></p>
        <p class="am-text-center"><a href="javascript:history.go(-1);">返回</a></p>
        <pre class="page-404">
          .----.
       _.'__    `.
   .--($)($$)---/#\
